...
public class ShopItem {
    ...
    public ShopItem(String name, String image_path, Double price, String description){
        this.name = name;
    ...
    public ShopItem(Integer item_id, String name, String image_path, Double price, String description){
